...
def count_coins(total):
    ...
    """
    "*** YOUR CODE HERE ***"
    def helper_function(total, big_coin):
        if total == 0:
            return 1
        elif total < 0:
            return 0
            ...
            return helper_function(total - big_coin, big_coin) + helper_function(total, next_smallest_coin(big_coin))
    return helper_function(total, 25)
